...
class Inference:
    ...
    def __call__(self):
        ...
        #   prediction: (n_test, n_gen, C, *dims)
        ...
        # reshape prediction: (n_test, n_gen, C, *dims)
        #   → (n_fields, n_unique_test, n_gen, C, *dims)  [block layout]
        #   → (n_unique_test, n_fields, n_gen, C, *dims)  [permute]
        #   → (n_unique_test, n_fields * n_gen, C, *dims)
        # [flatten realization × gen dims]
